...
<a href="https://xgboost.readthedocs.io/"><img src="https://img.shields.io/badge/XGBoost-FF6B00?style=for-the-badge&logo=xgboost&logoColor=white" alt="XGBoost"/></a>
...
<a href="https://restfulapi.net/"><img src="https://img.shields.io/badge/REST%20API-02569B?style=for-the-badge&logo=swagger&logoColor=white" alt="REST API"/></a>
...
<a href="https://matplotlib.org/"><img src="https://img.shields.io/badge/Matplotlib-FFFFFF?style=for-the-badge&logo=python&logoColor=black" alt="Matplotlib"/></a>
...
- **Real-time risk prediction** using XGBoost on geospatial features (rainfall, slope, elevation, soil type) + SMOTE for class imbalance
- **Geolocation pipeline** via Geopy, secure config with python-dotenv, model serialization with Joblib
- **Live deployment**: Streamlit web app with real-time Plotly dashboards and dynamic input forms
...
- **93% accuracy** (Precision: 0.92, Recall: 0.91, F1: 0.92) on 10,000+ insurance records via GridSearchCV + 5-fold CV
- **+18% minority recall** with SMOTE; **15+ predictive features** engineered via IQR outlier removal
- **Deployed**: Pickle-serialized model on FastAPI, containerized with Docker + docker-compose, hosted on Render
...
- **88%+ accuracy** across 3 benchmarked models (Logistic Regression, Random Forest, Decision Tree) with k-fold CV + ROC-AUC
- **Top 8 churn drivers** identified via feature selection and RFE
- **Deployment**: Power BI dashboard with DAX measures; Pickle-packaged model for real-time REST API scoring
